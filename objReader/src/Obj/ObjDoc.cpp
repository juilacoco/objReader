...
// ObjDoc.cpp : implementation of the CObjDoc class
//
...
// CObjDoc construction/destruction
...
void CObjDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CObjDoc::InitializeSearchContent()
{
...
void CObjDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
